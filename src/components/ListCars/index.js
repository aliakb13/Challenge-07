  ...
  return (
    <div className="container-fluid" style={{ padding: '100px' }}>
      <div className="row d-flex justify-content-center" id="cars-container">
        {getListCarsResult ? (
          getListCarsResult.filter((car) => car.capacity >= jumlah && car.available === tipe && Date.parse(DateTime(car.availableAt)) > formdate
          ).map((car) => {
            return (
              <div className="col-md-4" key={car.id}>
                <div className="card mb-3">
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-text"><img src="images/fi_users.png" className="me-2" alt="Users" />{car.capacity}</p>
                    <p className="card-text"><img src="images/fi_settings.png" className="me-2" alt="Transmission" />{car.transmission}</p>
                    <p className="card-text"><img src="images/fi_calendar.png" className="me-2" alt="Calender" />{car.year}</p>
